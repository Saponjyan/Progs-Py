...
'3629','3631','3632','3634','3635','3636','3637','3640','3648','3654',]
    ...
    def start3():
        stranica3=app1.stranica[0:2]
        mag3=app1.smag
        app1.send_msg("\n\n\n следующий цыкл \n\n\n")
        for i in mag3:
            mag={'Store':f'{i}'}
            for z in stranica3:
                response = requests.post(f" https://lenta.com/promo/?sorting=ByPriority&nodeCode=c565ed80964136a0374429fdc4d59ff8b{z}",headers=app1.headers,cookies=mag)
                sleep(2)
                ...
                try:
                    ...
                    for card in cards:
                        ...
                        card=" ".join(card)
                        if procent>app1.proc and "KABRITA" not in card:
                            sms=zz+"\n"+card+" \n "+da
                            #print(card,da)                            
                            app1.send_msg(sms)
                except:
